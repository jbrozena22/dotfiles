...
globalkeys = gears.table.join(
    ...
    awful.key({"Control"          }, "=", function () awful.spawn("/usr/bin/xfce4-display-settings -m")   end,
      {description = "open display settings manager", group = "layout"}),
    ...
    awful.key({modkey, "Control"            }, "l", function () awful.util.spawn("xfce4-screensaver-command -l") end, {description = "lock screen", group = "launcher"}),
